...
void create_write()
{
    ...
    strcpy(name, "write");
    FieldList *funcParameters = (FieldList*)(malloc(sizeof(FieldList)));
    funcParameters->name = "write";
    funcParameters->type = (Type*)(malloc(sizeof(Type)));
    ...
    funcType->u.function.paraNum = 1;
    funcType->u.function.returntype = returnType;
    funcType->u.function.params = funcParameters;
    insert_functiontable_node(functionTable, name, 2, 1, funcType);
}
